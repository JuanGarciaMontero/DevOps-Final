            ...
            steps {
                script {
                    def appCommand = """
                        ...
                        juangarciamontero/app15:1.0.72
                    """
                    ...
                    sh "docker exec ${appContainerId} chmod +x /Dev/manage.sh"

                    // Ejecuta manage.sh en la ruta actual
                    sh "docker exec ${appContainerId} /Dev/manage.sh"
                    sh "docker exec ${appContainerId} python /Dev/run.py"
